...
3) Copy the folder named 'copysafewebeditor' to 'moodle/lib/editor/tinymce/plugins'
...
4) Paste the code mentioned below to the end of 'moodle/index.php' file
    ...
    $copyweburl = new moodle_url('/mod/copysafeweb/copy.js');
    ?>

    <script src="<?php echo $liburl; ?>" type="text/javascript"></script>
    <script type="text/javascript" src="<?php echo $copyweburl; ?>"></script> 
    <?php
...
8) Nominate the settings applied to all CopySafe Web pages.
...
This Moodle module is provided free and as is. However you will need a license to use the CopySafe Web image encryption software. See  https://www.artistscope.net/ssl/order/order_web.asp 
